...
document.querySelector("#followers-li").addEventListener("click", function(){
    document.querySelector("#follower").style.display = 'initial'
})

document.querySelector("#follower-close").addEventListener("click", function(){
    document.querySelector("#follower").style.display = 'none'
})

document.querySelector("#followings-li").addEventListener("click", function(){
    document.querySelector("#following").style.display = 'initial'
})
